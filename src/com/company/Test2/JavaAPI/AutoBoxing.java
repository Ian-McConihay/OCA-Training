...
//
//Two instances of following wrapper objects,
// created through auto-boxing will always be same,
...
//
//For 1st statement, list.add(27); => Auto-boxing creates
// an integer object for 27.
//
//For 2nd statement, list.add(27); => Java compiler
// finds that there is already an Integer object
// in the memory with value 27, so it uses the same object.
//
//That is why System.out.println(list.get(0) == list.get(1));
// returns true.
//
